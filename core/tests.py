...
class FeeReceiptTests(AuthenticatedClientMixin, TestCase):
    ...
    def test_fee_collection_defaults_include_due_status_and_balance_fee_field(self):
        ...
        self.assertEqual(data["due_status"]["clear_through"], "APR")
        self.assertEqual(data["due_status"]["next_due_month"], "MAY")
        ...
        self.assertEqual(data["due_status"]["month_results"][0]["status"], "clear")
