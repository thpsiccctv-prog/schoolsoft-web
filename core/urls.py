...
urlpatterns = [
    ...
    path("academics/marks/entry/award-sheet/pdf/", module_required("marks")(views.award_sheet_pdf_view), name="award_sheet_pdf"),
    ...
    path("academics/marks/tabulation-register/excel/", module_required("marks")(views.tabulation_register_excel_view), name="tabulation_register_excel"),
